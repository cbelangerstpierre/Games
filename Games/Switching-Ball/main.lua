...
function Game2:load()
    Class = require("Switching-Ball.class")
    require("Switching-Ball.Image")
    require("Switching-Ball.Ball")
    ...
    sounds = {
        ['music'] = love.audio.newSource("Switching-Ball/sounds/music1.mp3", "static")
    }
...
function Game2:restart()
    ...
    currentRectangleOrientation = math.random(20, 90)
