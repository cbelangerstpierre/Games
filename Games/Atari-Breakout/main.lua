...
---@diagnostic disable-next-line: discard-returns
    ...
    highscores = {}
    initialHighscores = {}
    file = io.open("/home/cedric/LuaProjects/Mine/Games/Atari-Breakout/highscore3.txt", "r")
    highscores[1] = file:read("*all")
    initialHighscores[1] = highscores[1]
    file:close()
    
    file = io.open("/home/cedric/LuaProjects/Mine/Games/Atari-Breakout/highscore4.txt", "r")
    highscores[2] = file:read("*all")
    initialHighscores[2] = highscores[2]
    file:close()
    
    file = io.open("/home/cedric/LuaProjects/Mine/Games/Atari-Breakout/highscore5.txt", "r")
    highscores[3] = file:read("*all")
    initialHighscores[3] = highscores[3]
    file:close()
    
    file = io.open("/home/cedric/LuaProjects/Mine/Games/Atari-Breakout/highscore6.txt", "r")
            ...
            if NUMBER_OF_BRICKS == 0 then
                ...
                if tonumber(score) > tonumber(initialHighscores[currentLevel]) then
                    ...
                    if currentLevel == 1 then
                        file = io.open("/home/cedric/LuaProjects/Mine/Games/Atari-Breakout/highscore3.txt", "w")
                        file:write(score)
                        file:close()
                    elseif currentLevel == 2 then
                        file = io.open("/home/cedric/LuaProjects/Mine/Games/Atari-Breakout/highscore4.txt", "w")
                        file:write(score)
                        file:close()
                    elseif currentLevel == 3 then
                        file = io.open("/home/cedric/LuaProjects/Mine/Games/Atari-Breakout/highscore5.txt", "w")
                        file:write(score)
                        file:close()
                    elseif currentLevel == 4 then
                        file = io.open("/home/cedric/LuaProjects/Mine/Games/Atari-Breakout/highscore6.txt", "w")
                        file:write(score)
                        file:close()
                    end
                end
